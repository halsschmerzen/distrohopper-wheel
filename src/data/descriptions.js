const descriptions = {
    ...
    'Fedora': 'Fedora is a cutting-edge Linux distribution sponsored by Red Hat. Don\'t know much about this one',
    'Debian': 'Debian is a stable and versatile Linux distribution. Pretty much the holy grail of modern distros. ',
    'Arch Linux': 'Arch Linux is a lightweight and flexible Linux distribution. You are either super based if you use this one, or super annoying. Just use EndeavourOS tbh.',
    ...
    'CentOS': 'CentOS is a community-supported Linux distribution derived from Red Hat.',
    ...
    'Solus': 'Solus is an independent Linux distribution focused on desktop use. Never heard of that one lol',
